...
<body>
	...
	String confileDir = "C:/Users/bu456/eclipse-workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/LeaveOutWeb/leaveout/files/" + userNumString; //������ ������ ���丮
	String confilePath = confileDir + "/" + "content";
	...
	try{
		File contargetnameDir = new File(confilePath);
